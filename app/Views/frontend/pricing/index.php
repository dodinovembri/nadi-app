...
<!-- Mirrored from quiety.themetags.com/pricing-style.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Jan 2023 15:01:52 GMT -->
<head>
    <!--required meta tags-->
    <meta charset="utf-8">
    ...
    <!--title-->
    <title>Pricing Style - Software & IT Solutions HTML Template</title>
...
<body>
    ...
    <div class="main-wrapper">
                            ...
                            <li class="nav-item dropdown">
                               ...
                               16
                                                ...
                                                <div class="dropdown-info">
                                                    ...
                                                    <p><strong>Quiety Insurance</strong> landing</p>
                                                </div>
                                            </a>
                               ...
                               17
                                                ...
                                                <div class="dropdown-info">
                                                    ...
                                                    <p><strong>Sass Marketing</strong> landing</p>
                                                </div>
                                            </a>
        ...
        <section class="page-header position-relative overflow-hidden ptb-120 bg-dark" style="background: url('assets/img/page-header-bg.svg')no-repeat center left">
            <div class="container">
                <div class="row">
