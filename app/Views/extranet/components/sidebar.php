<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        <ul class="navigation-left">
            ...
            <li class="nav-item"><a class="nav-item-hold" href="<?= base_url('extranet/prospective-customer') ?>"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Prospective Customers</span></a>
                <div class="triangle"></div>
            </li>
        </ul>
    </div>
    <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
        ...
        <ul class="childNav" data-parent="extrakits">
            ...
            <li class="nav-item"><a href="<?= base_url('extranet/customer-type') ?>"><i class="nav-icon i-Medal-2"></i><span class="item-name">Customer Type</span></a></li>
