...
<head>
    ...
    <title>prospective_customer | Dias Project</title>
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Create New</h1>
                    <ul>
                        <li><a href="<?= base_url('extranet/prospective_customer') ?>">prospective_customer</a></li>
                        <li>Create New</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="<?= base_url('extranet/prospective_customer/store') ?>" method="post">
                                    <div class="row">
                                        <div class="col-md-6 form-group mb-3">
                                            <label for="picker1">Customer Type</label>
                                        ...
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            ...
                                            <a href="<?= base_url('extranet/prospective_customer') ?>"><button type="button" class="btn btn-warning">Cancel</button></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
